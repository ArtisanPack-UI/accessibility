...
it(
    'generates light and dark themes', function () {
        ...
        $colorGenerator->shouldReceive('generateAccessibleTextColor')->with('#ff0000', false, 'AA', false)->andReturn('#ff0000', '#ffffff');
...
it(
    'generates for a specific mode', function () {
        ...
        $colorGenerator->shouldReceive('generateAccessibleTextColor')->with('#ff0000', false, 'AA', false)->andReturn('#ff0000');
