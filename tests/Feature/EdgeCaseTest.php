...
test('handles invalid Tailwind color names', function ($invalidTailwind) {
    $generator = new AccessibleColorGenerator();
...
test('is case-insensitive for hex codes', function ($hex) {
    $generator = new AccessibleColorGenerator();
...
test('is case-insensitive for Tailwind colors', function ($tailwindColor) {
    $generator = new AccessibleColorGenerator();
