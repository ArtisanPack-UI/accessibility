...
This section contains comprehensive reference documentation for the ArtisanPack UI Accessibility package, including detailed API documentation and color references.
...
- **A11yServiceProvider**: Laravel service provider registration
- **A11y Facade**: Laravel facade for static access to accessibility methods
...
- Color families: Slate, Gray, Zinc, Neutral, Stone, Red, Orange, Amber, Yellow, Lime, Green, Emerald, Teal, Cyan, Sky, Blue, Indigo, Violet, Purple, Fuchsia, Pink, and Rose
