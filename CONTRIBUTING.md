# Contributing to ArtisanPack UI Accessibility

As an open source project, ArtisanPack UI Accessibility is open to contributions from everyone. You don't need to be a developer to contribute. Whether it's contributing code, writing documentation, testing the package or anything in between there's a place for you here to contribute.
...
There are a ton of different ways to contribute to ArtisanPack UI Accessibility even if you're not a developer. Here are some (but not all) of the ways you can contribute to the project:

* Write code for ArtisanPack UI Accessibility
* Test and report bugs found in the package
* Write documentation
* Write tutorials and talk about ArtisanPack UI Accessibility on your blog and/or social media profiles
...
ArtisanPack UI Accessibility is primarily hosted on GitLab, but you can contribute from any Git hosting platform.
...
Thank you for contributing to ArtisanPack UI Accessibility! Your contributions help make this project better for everyone.
